...
public class ImageModel {
    ...
    public static void loadImageForSDCard(final Context context, final DataCallback callback) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                callback.onSuccess(splitFolder(images,context.getString(R.string.string_pv)));
            }
        }).start();
    }
     ...
     * @return
     */
    private static ArrayList<Folder> splitFolder(ArrayList<Image> images,String all) {
        ArrayList<Folder> folders = new ArrayList<>();
        folders.add(new Folder(all , images));
