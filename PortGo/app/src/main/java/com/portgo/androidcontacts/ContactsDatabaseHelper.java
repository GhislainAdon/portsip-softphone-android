...
import com.portgo.androidcontacts.ContactsContract.Contacts.Photo;
import com.portgo.androidcontacts.ContactsContract.Data;
import com.portgo.androidcontacts.ContactsContract.Directory;
import com.portgo.androidcontacts.ContactsContract.DisplayNameSources;
import com.portgo.androidcontacts.ContactsContract.DisplayPhoto;
import com.portgo.androidcontacts.ContactsContract.FullNameStyle;
import com.portgo.androidcontacts.ContactsContract.Groups;
import com.portgo.androidcontacts.ContactsContract.PhoneticNameStyle;
...
public class ContactsDatabaseHelper extends SQLiteOpenHelper {
    ...
    public interface Tables {
        ...
        String AGGREGATION_EXCEPTIONS = "agg_exceptions";
        String SETTINGS = "settings";
        String DATA = "data";
        String GROUPS = "groups";
        String PRESENCE = "presence";
        String AGGREGATED_PRESENCE = "agg_presence";
        String NICKNAME_LOOKUP = "nickname_lookup";
        String CALLS = "calls";
        String STATUS_UPDATES = "status_updates";
        String PROPERTIES = "properties";
        String ACCOUNTS = "accounts";
        String VISIBLE_CONTACTS = "visible_contacts";
        String DIRECTORIES = "directories";
        String DEFAULT_DIRECTORY = "default_directory";
        ...
        String DATA_JOIN_MIMETYPES = "data "
        ...
        String RAW_CONTACTS_JOIN_SETTINGS_DATA_GROUPS = "raw_contacts "
        ...
        // NOTE: This requires late binding of GroupMembership MIME-type
        String SETTINGS_JOIN_RAW_CONTACTS_DATA_MIMETYPES_CONTACTS = "settings "
        ...
        String DATA_JOIN_PACKAGES_MIMETYPES_RAW_CONTACTS_GROUPS = "data "
                + "JOIN mimetypes ON (data.mimetype_id = mimetypes._id) "
                + "JOIN raw_contacts ON (data.raw_contact_id = raw_contacts._id) "
        ...
        String GROUPS_JOIN_PACKAGES = "groups "
                + "LEFT OUTER JOIN packages ON (groups.package_id = packages._id)";


        String ACTIVITIES = "activities";

        String ACTIVITIES_JOIN_MIMETYPES = "activities "
                + "LEFT OUTER JOIN mimetypes ON (activities.mimetype_id = mimetypes._id)";

        String ACTIVITIES_JOIN_PACKAGES_MIMETYPES_RAW_CONTACTS_CONTACTS =
                "activities "
        ...
        String NAME_LOOKUP_JOIN_RAW_CONTACTS = "name_lookup "
    ...
    public interface Views {
        ...
        String CONTACTS = "view_contacts";
        String ENTITIES = "view_entities";
    ...
    public interface Clauses {
        String HAVING_NO_GROUPS = "COUNT(" + DataColumns.CONCRETE_GROUP_ID + ") == 0";

        String GROUP_BY_ACCOUNT_CONTACT_ID = SettingsColumns.CONCRETE_ACCOUNT_NAME + ","
                + SettingsColumns.CONCRETE_ACCOUNT_TYPE + "," + RawContacts.CONTACT_ID;

        String RAW_CONTACT_IS_LOCAL = RawContactsColumns.CONCRETE_ACCOUNT_NAME
                + " IS NULL AND " + RawContactsColumns.CONCRETE_ACCOUNT_TYPE + " IS NULL AND "
                + RawContactsColumns.CONCRETE_DATA_SET + " IS NULL";

        String ZERO_GROUP_MEMBERSHIPS = "COUNT(" + GroupsColumns.CONCRETE_ID + ")=0";

        String OUTER_RAW_CONTACTS = "outer_raw_contacts";
        String OUTER_RAW_CONTACTS_ID = OUTER_RAW_CONTACTS + "." + RawContacts._ID;

        String CONTACT_IS_VISIBLE =
                "SELECT " +
        ...
        String GROUP_HAS_ACCOUNT_AND_SOURCE_ID = Groups.SOURCE_ID + "=? AND "
                + Groups.ACCOUNT_NAME + "=? AND " + Groups.ACCOUNT_TYPE + "=? AND "
                + Groups.DATA_SET + " IS NULL";

        String GROUP_HAS_ACCOUNT_AND_DATA_SET_AND_SOURCE_ID = Groups.SOURCE_ID + "=? AND "
                + Groups.ACCOUNT_NAME + "=? AND " + Groups.ACCOUNT_TYPE + "=? AND "
                + Groups.DATA_SET + "=?";

        String CONTACT_VISIBLE =
    ...
    public interface ContactsColumns {
        String LAST_STATUS_UPDATE_ID = "status_update_id";

        String CONCRETE_ID = Tables.CONTACTS + "." + BaseColumns._ID;

        String CONCRETE_PHOTO_FILE_ID = Tables.CONTACTS + "."
                + Contacts.PHOTO_FILE_ID;
        String CONCRETE_TIMES_CONTACTED = Tables.CONTACTS + "."
                + Contacts.TIMES_CONTACTED;
        String CONCRETE_LAST_TIME_CONTACTED = Tables.CONTACTS + "."
                + Contacts.LAST_TIME_CONTACTED;
        String CONCRETE_STARRED = Tables.CONTACTS + "." + Contacts.STARRED;
        String CONCRETE_CUSTOM_RINGTONE = Tables.CONTACTS + "."
                + Contacts.CUSTOM_RINGTONE;
        String CONCRETE_SEND_TO_VOICEMAIL = Tables.CONTACTS + "."
                + Contacts.SEND_TO_VOICEMAIL;
        String CONCRETE_LOOKUP_KEY = Tables.CONTACTS + "."
                + Contacts.LOOKUP_KEY;
    }
    ...
    public interface RawContactsColumns {
        ...
        String CONCRETE_DISPLAY_NAME =
                Tables.RAW_CONTACTS + "." + DISPLAY_NAME;
        String CONCRETE_CONTACT_ID =
                Tables.RAW_CONTACTS + "." + RawContacts.CONTACT_ID;
        String CONCRETE_NAME_VERIFIED =
    ...
    public interface DataColumns {
        ...
        String CONCRETE_ID = Tables.DATA + "." + BaseColumns._ID;
        String CONCRETE_MIMETYPE_ID = Tables.DATA + "." + MIMETYPE_ID;
        String CONCRETE_RAW_CONTACT_ID = Tables.DATA + "."
                + Data.RAW_CONTACT_ID;
        String CONCRETE_GROUP_ID = Tables.DATA + "."
    ...
    public interface ExtensionsColumns {
        String NAME = Data.DATA1;
        String VALUE = Data.DATA2;
    }
    ...
    public interface PhoneColumns {
        String NORMALIZED_NUMBER = Data.DATA4;
        String CONCRETE_NORMALIZED_NUMBER = DataColumns.CONCRETE_DATA4;
    }

    public interface GroupsColumns {
        String PACKAGE_ID = "package_id";

        String CONCRETE_ID = Tables.GROUPS + "." + BaseColumns._ID;
        ...
        String CONCRETE_DATA_SET = Tables.GROUPS + "." + Groups.DATA_SET;
        String CONCRETE_ACCOUNT_TYPE_AND_DATA_SET = Tables.GROUPS + "." +
    ...
    public interface PackagesColumns {
        ...
        String CONCRETE_ID = Tables.PACKAGES + "." + _ID;
    }
    ...
    public interface MimetypesColumns {
        ...
        String CONCRETE_ID = Tables.MIMETYPES + "." + BaseColumns._ID;
    ...
    public interface SettingsColumns {
        String CONCRETE_ACCOUNT_NAME = Tables.SETTINGS + "."
                + Settings.ACCOUNT_NAME;
        String CONCRETE_ACCOUNT_TYPE = Tables.SETTINGS + "."
                + Settings.ACCOUNT_TYPE;
        String CONCRETE_DATA_SET = Tables.SETTINGS + "."
                + Settings.DATA_SET;
    }
    ...
    public interface StreamItemsColumns {
        ...
        String CONCRETE_RAW_CONTACT_ID =
...
//            sSingleton = new ContactsDatabaseHelper(context, path+ File.separator+DATABASE_NAME, true);
//        }
        if (sSingleton == null) {
...
//        LegacyApiSupport.createDatabase(db);
        ...
        //插入一个默认的不可见群组，用来存储尚未通过请求的好友（从subscribe来的）
        ContentValues values = new ContentValues();
        values.put(ContactsContract.Groups.TITLE, com.portgo.androidcontacts.ContactsContract.Groups.subScribeGroup);
        values.put(ContactsContract.Groups.GROUP_VISIBLE,0);
        db.insert(Tables.GROUPS,null,values);

        values = new ContentValues();
        values.put(ContactsContract.Groups.TITLE, com.portgo.androidcontacts.ContactsContract.Groups.sysDeleteGroup);
        values.put(ContactsContract.Groups.GROUP_VISIBLE,0);
        db.insert(Tables.GROUPS,null,values);
...
//    /**
//     * Find the mime-type for the given {@link Activities_ID}.
//     */
