...
import com.portgo.R;
import com.portgo.androidcontacts.SyncStateContentProviderHelper;
import com.portgo.androidcontacts.ContactAggregator.AggregationSuggestionParameter;
import com.portgo.androidcontacts.ContactLookupKey.LookupKeySegment;
import com.portgo.androidcontacts.ContactsDatabaseHelper.AggregatedPresenceColumns;
import com.portgo.androidcontacts.ContactsDatabaseHelper.AggregationExceptionColumns;
import com.portgo.androidcontacts.ContactsDatabaseHelper.Clauses;
import com.portgo.androidcontacts.ContactsDatabaseHelper.ContactsColumns;
import com.portgo.androidcontacts.ContactsDatabaseHelper.ContactsStatusUpdatesColumns;
import com.portgo.androidcontacts.ContactsDatabaseHelper.DataColumns;
import com.portgo.androidcontacts.ContactsDatabaseHelper.DataUsageStatColumns;
import com.portgo.androidcontacts.ContactsDatabaseHelper.GroupsColumns;
import com.portgo.androidcontacts.ContactsDatabaseHelper.Joins;
import com.portgo.androidcontacts.ContactsDatabaseHelper.NameLookupColumns;
import com.portgo.androidcontacts.ContactsDatabaseHelper.NameLookupType;
import com.portgo.androidcontacts.ContactsDatabaseHelper.PhoneColumns;
import com.portgo.androidcontacts.ContactsDatabaseHelper.PhoneLookupColumns;
import com.portgo.androidcontacts.ContactsDatabaseHelper.PhotoFilesColumns;
import com.portgo.androidcontacts.ContactsDatabaseHelper.PresenceColumns;
import com.portgo.androidcontacts.ContactsDatabaseHelper.RawContactsColumns;
import com.portgo.androidcontacts.ContactsDatabaseHelper.SearchIndexColumns;
import com.portgo.androidcontacts.ContactsDatabaseHelper.SettingsColumns;
import com.portgo.androidcontacts.ContactsDatabaseHelper.StatusUpdatesColumns;
import com.portgo.androidcontacts.ContactsDatabaseHelper.StreamItemPhotosColumns;
import com.portgo.androidcontacts.ContactsDatabaseHelper.StreamItemsColumns;
import com.portgo.androidcontacts.ContactsDatabaseHelper.Tables;
import com.portgo.androidcontacts.ContactsDatabaseHelper.Views;
import com.portgo.androidcontacts.SearchIndexManager.FtsQueryBuilder;
import com.portgo.androidcontacts.DbQueryUtils;
...
import com.portgo.androidcontacts.ContactsContract.AggregationExceptions;
import com.portgo.androidcontacts.ContactsContract.Authorization;
import com.portgo.androidcontacts.ContactsContract.CommonDataKinds.Email;
import com.portgo.androidcontacts.ContactsContract.CommonDataKinds.GroupMembership;
import com.portgo.androidcontacts.ContactsContract.CommonDataKinds.Im;
import com.portgo.androidcontacts.ContactsContract.CommonDataKinds.Nickname;
import com.portgo.androidcontacts.ContactsContract.CommonDataKinds.Note;
import com.portgo.androidcontacts.ContactsContract.CommonDataKinds.Organization;
import com.portgo.androidcontacts.ContactsContract.CommonDataKinds.Phone;
import com.portgo.androidcontacts.ContactsContract.CommonDataKinds.Photo;
import com.portgo.androidcontacts.ContactsContract.CommonDataKinds.SipAddress;
import com.portgo.androidcontacts.ContactsContract.CommonDataKinds.StructuredName;
import com.portgo.androidcontacts.ContactsContract.CommonDataKinds.StructuredPostal;
import com.portgo.androidcontacts.ContactsContract.ContactCounts;
import com.portgo.androidcontacts.ContactsContract.Contacts;
import com.portgo.androidcontacts.ContactsContract.Contacts.AggregationSuggestions;
import com.portgo.androidcontacts.ContactsContract.Data;
import com.portgo.androidcontacts.ContactsContract.DataUsageFeedback;
import com.portgo.androidcontacts.ContactsContract.Directory;
import com.portgo.androidcontacts.ContactsContract.DisplayPhoto;
import com.portgo.androidcontacts.ContactsContract.Groups;
import com.portgo.androidcontacts.ContactsContract.Intents;
import com.portgo.androidcontacts.ContactsContract.PhoneLookup;
import com.portgo.androidcontacts.ContactsContract.PhotoFiles;
import com.portgo.androidcontacts.ContactsContract.Profile;
import com.portgo.androidcontacts.ContactsContract.ProviderStatus;
import com.portgo.androidcontacts.ContactsContract.RawContacts;
import com.portgo.androidcontacts.ContactsContract.RawContactsEntity;
import com.portgo.androidcontacts.ContactsContract.SearchSnippetColumns;
import com.portgo.androidcontacts.ContactsContract.Settings;
import com.portgo.androidcontacts.ContactsContract.StatusUpdates;
import com.portgo.androidcontacts.ContactsContract.StreamItemPhotos;
import com.portgo.androidcontacts.ContactsContract.StreamItems;
import com.portgo.androidcontacts.OpenableColumns;
import com.portgo.androidcontacts.SyncStateContract;
...
//        if (PortApplication.getLogUtils().isLoggable(Constants.PERFORMANCE_TAG, Log.DEBUG)) {
//            PortApplication.getLogUtils().d(Constants.PERFORMANCE_TAG, "ContactsProvider2.onCreate start");
//        }
        super.onCreate();
        try {
            return initialize();
...
//            if (PortApplication.getLogUtils().isLoggable(Constants.PERFORMANCE_TAG, Log.DEBUG)) {
//                PortApplication.getLogUtils().d(Constants.PERFORMANCE_TAG, "ContactsProvider2.onCreate finish");
//            }
        }
    }
...
//                DEFAULT_PREAUTHORIZED_URI_EXPIRATION);
        mPreAuthorizedUriDuration = 1000*60*30;//
...
//        mProfileAggregator.setEnabled(SystemProperties.getBoolean(AGGREGATE_CONTACTS, true));
        mProfileAggregator.setEnabled(true);
...
//        PortApplication.getLogUtils().v(TAG, "Importing legacy contacts");
...
//        PortApplication.getLogUtils().v(TAG, "Failed to import legacy contacts");
//
...
//    }
    ...
    /* Visible for testing */
    /* package */
    //委托联系人，A联系人的委托人，拥有对A联系人的账号的部分管理权限。 https://www.facebook.com/help/241237032913527/?helpref=hc_fnav
...
//            }
//        } catch (Throwable e) {
//            PortApplication.getLogUtils().e(TAG, "Legacy contact import failed", e);
//        }
...
//    }
    ...
    protected int deleteInTransaction(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            ...
            default: {
                mSyncToNetwork = true;
                return 0;//mLegacyApiSupport.delete(uri, selection, selectionArgs);不支持代理联系人
            }
        }
    }
    ...
    protected int updateInTransaction(Uri uri, ContentValues values, String selection,
        ...
        switch(match) {
            ...
            default: {
                mSyncToNetwork = true;
                return 0;//mLegacyApiSupport.update(uri, values, selection, selectionArgs); 不支持代理联系人
            }
        }
...
//                    PortApplication.getLogUtils().d(TAG, "removing data for removed account " + accountWithDataSet);
...
//            PortApplication.getLogUtils().e(TAG, "Cannot obtain sync flag for account: " + account, e);
//            return false;
//        }
//    }
            ...
            case PHONES_FILTER: {
                ...
                if (uri.getPathSegments().size() > 2) {
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                        number = PhoneNumberUtils.normalizeNumber(filterParam);
                    }
...
//                    byteData.length);
//        } catch (IOException e) {
//            PortApplication.getLogUtils().w(TAG, "Problem writing stream into an ParcelFileDescriptor: " + e.toString());
//            return null;
//        }
//    }
...
//                PortApplication.getLogUtils().w(TAG, "Failed to init VCardComposer");
//                return;
//            }
//
...
//            }
//        } catch (IOException e) {
//            PortApplication.getLogUtils().e(TAG, "IOException: " + e);
//        } finally {
//            composer.terminate();
//            if (writer != null) {
//                try {
//                    writer.close();
//                } catch (IOException e) {
//                    PortApplication.getLogUtils().w(TAG, "IOException during closing output stream: " + e);
//                }
//            }
//        }
    }
...
//                return mLegacyApiSupport.getType(uri);//不支持；
        }
    }
...
//            }
//        } catch (Throwable e) {
//            PortApplication.getLogUtils().e(TAG, "Cannot determine the default account for contacts compatibility", e);
//        }
//        return null;
//    }
...
//            }
//        } catch (RemoteException e) {
//            PortApplication.getLogUtils().e(TAG, "Could not acquire sync adapter types");
//        }
//
//        if (writable == null) {
//            writable = false;
