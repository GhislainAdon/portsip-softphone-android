...
import com.portgo.androidcontacts.ContactsDatabaseHelper.ExtensionsColumns;
import com.portgo.androidcontacts.ContactsDatabaseHelper.GroupsColumns;
import com.portgo.androidcontacts.ContactsDatabaseHelper.MimetypesColumns;
...
//        sExtensionProjectionMap.put(Extensions._ID,
//                Extensions._ID);
//        sExtensionProjectionMap.put(Extensions.PERSON_ID,
//                Extensions.PERSON_ID);
//        sExtensionProjectionMap.put(Extensions.NAME,
//                Extensions.NAME);
//        sExtensionProjectionMap.put(Extensions.VALUE,
//                Extensions.VALUE);
//
...
//        PortApplication.getLogUtils().i(TAG, "Bootstrapping database legacy support");
//        createViews(db);
...
//
//        mValues.put(Data.RAW_CONTACT_ID, rawContactId);
//        mValues.put(Data.MIMETYPE, Extensions.CONTENT_ITEM_TYPE);
//
...
//                qb.setProjectionMap(sExtensionProjectionMap);
//                applyRawContactsAccount(qb);
//                qb.appendWhere(" AND " + Extensions._ID + "=");
//                qb.appendWhere(uri.getPathSegments().get(1));
//                break;
//
...
//                qb.setProjectionMap(sExtensionProjectionMap);
//                applyRawContactsAccount(qb);
//                qb.appendWhere(" AND " + Extensions.PERSON_ID + "=");
//                qb.appendWhere(uri.getPathSegments().get(1));
//                break;
//
