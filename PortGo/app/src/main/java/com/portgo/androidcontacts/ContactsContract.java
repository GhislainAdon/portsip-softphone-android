...
import static android.provider.ContactsContract.CommonDataKinds.Im.getProtocolLabelResource;
...
//    public static final String AUTHORITY = "com.android.contacts";
    public static final String AUTHORITY = BuildConfig.PROVIDER_CONTACT;
    ...
    public static class Contacts implements BaseColumns, ContactsColumns,
         ...
         * {@link } columns when queried, or returns the
    ...
    public static final class Profile implements BaseColumns, ContactsColumns,
         ...
         * Provides {@link } columns when queried, or returns the
    ...
    protected interface StatusColumns {
         ...
         */
        @Deprecated
        String PRESENCE_STATUS = PRESENCE;
    ...
    public static final class CommonDataKinds {
        ...
        public static final class StructuredPostal implements DataColumnsWithJoins, CommonColumns {
             ...
             */
            public static final int getTypeLabelResource(int type) {
                return android.provider.ContactsContract.CommonDataKinds.StructuredPostal.getTypeLabelResource(type);
            }
        ...
        public static final class Im implements DataColumnsWithJoins, CommonColumns {
             ...
             */
            public static final int getTypeLabelResource(int type) {
                return android.provider.ContactsContract.CommonDataKinds.Im.getTypeLabelResource(type);
            }
            ...
            public static final int getProtocolLabelResource(int type) {
                return android.provider.ContactsContract.CommonDataKinds.Im.getProtocolLabelResource(type);
//                switch (type) {
...
//                }
        ...
        public static final class Relation implements DataColumnsWithJoins, CommonColumns {
             ...
             */
            public static final int getTypeLabelResource(int type) {
                return  android.provider.ContactsContract.CommonDataKinds.Relation.getTypeLabelResource(type);
            }
        ...
        public static final class Event implements DataColumnsWithJoins, CommonColumns {
            ...
            public static int getTypeResource(Integer type) {
                return  android.provider.ContactsContract.CommonDataKinds.Event.getTypeResource(type);
        ...
        public static final class SipAddress implements DataColumnsWithJoins, CommonColumns {
             ...
             */
            public static final int getTypeLabelResource(int type) {
                return android.provider.ContactsContract.CommonDataKinds.SipAddress.getTypeLabelResource(type);
            }
    ...
    protected interface GroupsColumns {
         ...
         * @hide
         */
        String PARAM_RETURN_GROUP_COUNT_PER_ACCOUNT =
    ...
    public static final class Groups implements BaseColumns, GroupsColumns, SyncColumns {
        ...
        public static final String subScribeGroup = "portsipSub";
        public static final String sysDeleteGroup = "portsipDel";
        public static final int subScribeGroupId = 1;
        public static final int sysDeleteGroupId = 2;
        /**
