...
/**
 * Created by huacai on 2018/1/29.
 */

public class CellCallReceiver  extends BroadcastReceiver{
...
//                PortApplication.getLogUtils().d(TAG, "call OUT:" + phoneNumber);
            }else{
...
//注意，方法必须写在super方法后面，否则incomingNumber无法获取到值。
                ...
                switch(state){
                    case TelephonyManager.CALL_STATE_IDLE:
                        System.out.println("haugup");
                        break;
                    case TelephonyManager.CALL_STATE_OFFHOOK:
                        System.out.println("accept");
                        break;
                    case TelephonyManager.CALL_STATE_RINGING:
                        System.out.println("ring:num "+incomingNumber);
                        break;
                }
            }
        };
