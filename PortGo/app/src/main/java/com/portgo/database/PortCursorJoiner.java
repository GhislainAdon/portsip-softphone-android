 ...
 * </pre>
 */
public final class PortCursorJoiner
        implements Iterator<PortCursorJoiner.Result>, Iterable {
    ...
    JoinerCompare joinerCompare = null;
    /**
     ...
     */
    public PortCursorJoiner(
            Cursor cursorLeft, String[] columnNamesLeft,
            Cursor cursorRight, String[] columnNamesRight,JoinerCompare compare) {
        ...
        if(joinerCompare==null){
            joinerCompare = new Compare();
        }
    }
    ...
    public Result next() {
        ...
        if (hasLeft && hasRight) {
            ...
            switch (joinerCompare.compare(mValues)) {
                case -1:
    ...
    public static interface JoinerCompare{
        public int compare(String ...values);
    }

    class  Compare implements JoinerCompare{
