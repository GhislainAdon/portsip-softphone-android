...
public class SlideMenuLayout extends FrameLayout {
	...
	public SlideMenuLayout(View contentView, SlideMenuView menuView) {
	...
	private void init() {
		...
		mGestureListener = new SimpleOnGestureListener() {
			...
			public boolean onFling(MotionEvent e1, MotionEvent e2,
				...
				// PortApplication.getLogUtils().i("byz", MAX_VELOCITYX + ", velocityX = " + velocityX);
	...
	public void setmMenuView(SlideMenuView menuView) {
		mMenuView = menuView;
		mMenuView.setLayout(this);
		mMenuView.setPosition(position);
		mMenuView.setId(MENU_VIEW_ID);
	...
	public boolean onSwipe(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			// PortApplication.getLogUtils().i("byz", "downX = " + mDownX + ", moveX = " + event.getX());
	...
	private void swipe(int dis) {
		...
		if (mSwipeDirection == SlideMenuListView.DIRECTION_LEFT) {
