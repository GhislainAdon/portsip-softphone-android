...
import com.portgo.view.emotion.adapter.BaseEmotionAdapter;
import com.portgo.view.emotion.adapter.CustomEmotionAdapter;
import com.portgo.view.emotion.adapter.EmotionAdapter;
...
public class EmotionView extends LinearLayout {
    ...
    private void showEmotionIndicator(int count) {
        ...
        emotionIndicator.setDotHeight(UnitConversion.dp2px(mContext, 5));
        emotionIndicator.setDotWidth(UnitConversion.dp2px(mContext, 5));
        emotionIndicator.setDotMargin(UnitConversion.dp2px(mContext, 10));
