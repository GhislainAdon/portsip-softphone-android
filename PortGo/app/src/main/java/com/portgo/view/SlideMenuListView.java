...
public class SlideMenuListView extends ListView {
    ...
    public void setAdapter(ListAdapter adapter) {
        super.setAdapter(new SlideMenuAdapter(getContext(), adapter) {
            ...
            @Override
            public void onItemClick(SlideMenuView view, SlideMenu menu,
                                    int index) {
                boolean flag = false;
                    ...
                    if (mTouchState == TOUCH_STATE_NONE) {
                        if (Math.abs(dy) > MAX_Y) {
                            ...
                            if (mOnSlideListener != null) {
                                mOnSlideListener.onSlideStart(mTouchPosition);
                            }
                        }
                    }
                    return true;
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                if (mTouchState == TOUCH_STATE_X) {
                    ...
                    if (mOnSlideListener!= null) {
                        mOnSlideListener.onSlideEnd(mTouchPosition);
                    }
                    ev.setAction(MotionEvent.ACTION_CANCEL);
                    super.onTouchEvent(ev);
                    return true;
    ...
    public void setMenuCreator(SlideMenuCreator menuCreator) {
    ...
    public interface OnMenuItemClickListener {
        boolean onMenuItemClick(int position, SlideMenu menu, int index);
    }

    public interface OnSlideListener {
        void onSlideStart(int position);

        void onSlideEnd(int position);
    }
