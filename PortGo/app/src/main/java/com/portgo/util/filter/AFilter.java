...
import com.portgo.util.OpenGlUtils;
...
public abstract class AFilter {
    ...
    Context mContext;
    public AFilter(@NonNull Context context){
        mContext =context;
    ...
    protected final void createProgramByAssetsFile(String vertex, String fragment){
        createProgram(OpenGlUtils.uRes(mContext,vertex),OpenGlUtils.uRes(mContext,fragment));
    }
