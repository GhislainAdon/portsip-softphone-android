...
import com.portgo.util.filter.RotationOESFilter;
...
import com.portgo.util.media.VideoInfo;
...
public class VideoDrawer implements GLSurfaceView.Renderer {
    ...
    public VideoDrawer(Context context){
        mPreFilter = new RotationOESFilter(context);//旋转相机操作
        mShow = new NoFilter(context);
