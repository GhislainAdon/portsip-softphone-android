...
package com.portgo.util.record.video;
...
import com.portgo.util.gpufilter.basefilter.MagicCameraInputFilter;
import com.portgo.util.record.gles.EglCore;
...
public class TextureMovieEncoder implements Runnable {
    ...
    private AFilter mShowFilter=null;
    public TextureMovieEncoder(Context context) {
        mContext = context;
        mShowFilter = new NoFilter(mContext);
    }
    ...
    public static class EncoderConfig {
        ...
        public EncoderConfig(String path, int width, int height, int bitRate,int orientation,
        ...
        public String toString() {
            return "EncoderConfig: " + mWidth + "x" + mHeight + " @" + mBitRate +" Orientation" + mOrientation +
    ...
    private void handleStartRecording(EncoderConfig config) {
        prepareEncoder(config.mEglContext, config.mWidth, config.mHeight, config.mBitRate,config.mOrientation,
                config.path);
    }
    ...
    private void handleSetTexture(int id) {
        //PortApplication.getLogUtils().d(TAG, "handleSetTexture " + id);
        mTextureId = id;
    }
    ...
    //orientation,最终视频旋转角度
    private void prepareEncoder(EGLContext sharedContext, int width, int height, int bitRate,int orientation,
                                String path) {
        try {
            mVideoEncoder = new VideoEncoderCore(width, height, bitRate, orientation,path);
